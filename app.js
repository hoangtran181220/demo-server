...
mongoose.connect('mongodb://localhost:27017/flowers', { useNewUrlParser: true, useUnifiedTopology: true }, err => {
  if (err) throw err;
...
app.use(
  session({
    ...
    resave: false,
    store: new MongoDBStore({ uri: 'mongodb://localhost:27017/flowers', collection: 'sessions' }),
